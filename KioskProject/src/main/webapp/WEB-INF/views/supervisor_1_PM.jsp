         ...
         <div class="board_list">
            ...
            <c:forEach items="${menu_list }" var="m">
               <div>
                  ...
                  String uploadDir = userHome + File.separator + "uploads" + File.separator + "img_menu";
                  %> ${m.menu_name_eng.replaceAll(' ', '_')}.jpg
                            <img src="<%=uploadDir %>/${m.menu_name_eng.replaceAll(' ', '_')}.jpg" alt="${m.menu_name_eng.replaceAll(' ', '_')}.jpg" width="100" height="100">
                     <p>"<%=uploadDir %>/${m.menu_name_eng.replaceAll(' ', '_')}.jpg</p>
                            <br>${m.menu_name_eng}.jpg
                        </div> --%>
                  <div class="menu_img">
                     <img
                        src="${pageContext.request.contextPath}/img_menu/${m.menu_name_eng.replaceAll(' ', '_')}.jpg"
                        alt="${m.menu_name_eng.replaceAll(' ', '_')}.jpg" width="100"
                        height="100">
                     <p>${pageContext.request.contextPath}/img_menu/${m.menu_name_eng.replaceAll(' ', '_')}.jpg</p>
                     <br>${m.menu_name_eng}.jpg
                  </div>
                  <div class="bt_wrap">
                     <a class="modify"
