...
<script type="text/javascript"
	src="<c:url value='/resources/js/supervisor_MM.js' />"></script>
<script type="text/javascript">
	var cpath = "${cpath}";
</script>
</head>
<body>
	...
	<div class="container">
		...
		<div class="search">
			<form class="search_container" action="${cpath }/mem_search.do"
				method="get">
				<input type="text" id="search_bar" placeholder="전화번호 검색"> <img
					class="search_icon"
